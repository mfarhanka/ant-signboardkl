...
$siteTitle = 'Hubungi Kami | A&T Media Sdn. Bhd. Signboard, Signage & Printing KL';
$siteDescription = 'Hubungi A&T Media Sdn. Bhd. untuk signboard, signage, printing, 3D lettering, fabric lightbox, dan sokongan pemasangan di Kuala Lumpur, Klang Valley, Selangor, dan Seremban.';
$siteKeywords = 'hubungi signboard KL, hubungi signage Kuala Lumpur, sebut harga signboard Selangor, pembekal signage Klang Valley, A&T Media contact';
...
$whatsAppUrl = 'https://wa.me/60167013295?text=' . rawurlencode('Hai A&T Media, saya ingin mendapatkan sebut harga signage.');
...
<html lang="ms-MY">
  ...
  <body>
      ...
      <div class="container">
        <div class="row align-items-start">
          <div class="col-lg-5 mb-4 mb-lg-0">
            ...
            <h2 class="section-title mb-3">Bincang dengan A&T Media tentang projek signage anda.</h2>
            <p class="section-copy">Hantar butiran projek, artwork, ukuran, dan lokasi anda. Kami boleh membantu dengan signboard, signage, printing, 3D lettering, lightbox, dan perancangan pemasangan.</p>
            ...
            <div class="contact-actions">
              <a class="btn btn-red" href="<?php echo htmlspecialchars($whatsAppUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener"><i class="fab fa-whatsapp mr-2"></i>WhatsApp Kami</a>
              <a class="btn btn-outline-light" href="<?php echo htmlspecialchars($mapUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener"><i class="fas fa-map-marked-alt mr-2"></i>Buka Peta</a>
            </div>
          </div>
          <div class="col-lg-7">
            <form class="contact-form-card" action="contact-submit.php" method="post">
              <h2>Ceritakan tentang projek anda</h2>
              <div class="form-row">
    ...
    <a class="whatsapp-float" href="<?php echo htmlspecialchars($whatsAppUrl, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener" aria-label="Chat di WhatsApp">
