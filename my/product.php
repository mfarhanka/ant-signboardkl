...
$whatsAppText = $product ? 'Hai, saya berminat dengan ' . $product['title'] . '. ' . $canonicalUrl : 'Hai, saya ingin mengetahui maklumat lanjut.';
...
<html lang="ms-MY">
  ...
  <body>
    ...
    <header class="page-title">
      <div class="container">
        <h1><?php echo htmlspecialchars($product['title'] ?? 'Produk Tidak Dijumpai', ENT_QUOTES, 'UTF-8'); ?></h1>
      </div>
    </header>
      ...
      <div class="container">
        <?php if (!$product): ?>
          <div class="product-info">
            <h2>Produk Tidak Dijumpai</h2>
            <p>Produk yang anda buka tidak lagi tersedia. Sila kembali ke halaman produk untuk melihat katalog semasa.</p>
            <a class="btn btn-red" href="products.php">Kembali ke Produk</a>
          </div>
        <?php else: ?>
          <div class="row align-items-start">
            ...
            <div class="col-lg-6">
              <section class="product-info">
                ...
                <p><?php echo nl2br(htmlspecialchars($product['description'] ?: 'Hubungi A&T Media untuk butiran produk, perancangan artwork, cadangan bahan, dan sokongan pemasangan.', ENT_QUOTES, 'UTF-8')); ?></p>
                <div class="detail-actions">
                  <a class="btn btn-red btn-lg" href="<?php echo htmlspecialchars($whatsAppUrl, ENT_QUOTES, 'UTF-8'); ?>">
                    <i class="fab fa-whatsapp mr-2" aria-hidden="true"></i>WhatsApp Kami
                  </a>
                  <a class="btn btn-outline-secondary btn-lg" href="products.php">Kembali ke Produk</a>
                </div>
              </section>
            </div>
          </div>
