...
$siteDescription = 'A&T Media Sdn. Bhd. menyediakan servis sehenti untuk signboard, signage, printing, reka bentuk, produksi, dan pemasangan di Kuala Lumpur (KL), Klang Valley, Selangor, dan Seremban.';
  ...
  <body>
    ...
    <header class="hero">
      <div class="container">
        <div class="hero-content">
          ...
          <h1>Signage profesional dengan <span>impak lebih kuat.</span></h1>
          <p>A&T Media Sdn. Bhd. menyediakan sokongan sehenti yang boleh dipercayai untuk konsultasi, reka bentuk, produksi, printing, pemasangan di lokasi, dan penilaian kualiti produk signage.</p>
          <div class="hero-actions">
            <a class="btn btn-red btn-lg px-4" href="contact.php"><i class="fas fa-paper-plane mr-2"></i>Minta Sebut Harga</a>
            <a class="btn btn-outline-light btn-lg px-4" href="products.php"><i class="fas fa-th-large mr-2"></i>Lihat Produk</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row no-gutters">
          <div class="col-md-4 quick-item px-3">
            ...
            <div><strong>Konsultasi hingga Pemasangan</strong><span>Sokongan signage sehenti yang boleh dipercayai</span></div>
          </div>
          <div class="col-md-4 quick-item px-3">
            <i class="fas fa-map-marker-alt"></i>
            <div><strong>KL, Klang Valley & Selangor</strong><span>Servis untuk Kuala Lumpur, Selangor dan Seremban</span></div>
          </div>
          <div class="col-md-4 quick-item px-3">
            <i class="fas fa-bolt"></i>
            <div><strong>Signage & Printing</strong><span>Produksi dan kemasan dalaman</span></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="services">
      <div class="container">
        <div class="row mb-4">
          <div class="col-lg-7">
            <div class="section-kicker">Servis kami</div>
            <h2 class="section-title">Penyelesaian signboard, signage, dan printing untuk jenama komersial.</h2>
          </div>
          <div class="col-lg-5">
            <p class="section-copy">Daripada konsultasi awal hingga pemasangan akhir, setiap projek dirancang mengikut visibiliti, pilihan bahan, kualiti produksi, dan keperluan praktikal di lokasi.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-card">
              ...
              <h3>Signboard</h3>
              <p>Penyelesaian signboard tersuai untuk kedai, unit komersial, tapak pembinaan, dan frontage perniagaan.</p>
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-card">
              ...
              <h3>Signage</h3>
              <p>Signage indoor dan outdoor untuk visibiliti jenama, arah pandu, promosi, dan paparan yang jelas.</p>
              <div class="product-tags">
          ...
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="service-card">
              ...
              <p>Huruf 3D untuk storefront, pejabat, dan ruang berjenama yang memerlukan kehadiran visual yang kuat.</p>
              <div class="product-tags">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <div class="service-card">
              ...
              <h3>Printing</h3>
              <p>Sokongan printing komersial untuk paparan promosi, banner, decal, dan grafik perniagaan.</p>
              <div class="product-tags">
                <span>Display Set</span>
                <span>Wood Easel Stand</span>
                <span>Exhibition Booth</span>
                <span>Backdrop Display</span>
                <span>Sticker Servis</span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-md-0">
            <div class="service-card">
              ...
              <p>Sistem paparan bercahaya yang kemas untuk retail, exhibition, showroom, dan ruang jenama berimpak tinggi.</p>
              <div class="product-tags">
          ...
          <div class="col-md-6 col-lg-4">
            <div class="service-card">
              ...
              <p>Signage paparan mudah alih untuk event, ruang retail, kempen, wayfinding, dan promosi produk.</p>
              <div class="product-tags">
    ...
    <section id="projects" class="work-band">
      <div class="container">
        <div class="row mb-4">
          <div class="col-lg-7">
            <div class="section-kicker">Kerja pilihan</div>
            <h2 class="section-title">Beberapa contoh produk daripada A&T Media.</h2>
          </div>
          <div class="col-lg-5">
            <p class="section-copy">Halaman produk memaparkan kerja signage praktikal merangkumi 3D lettering, lightbox, billboard, construction board, sticker, serta box-up sign frontlit atau backlit.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="project-card">
              ...
              <div class="project-card-body">
                ...
                <p>Signage 3D untuk frontage retail dan visibiliti jenama.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="project-card">
              ...
              <div class="project-card-body">
                ...
                <p>Signage paparan bercahaya untuk visibiliti lebih kuat.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="project-card">
              ...
              <div class="project-card-body">
                ...
                <p>Signage outdoor untuk keperluan projek dan hoarding.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="project-card">
              ...
              <div class="project-card-body">
                ...
                <p>Signage gabungan bahan untuk ruang dalaman berjenama.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="section-kicker">Tentang A&T Media</div>
            <h2 class="section-title">Rakan sehenti yang boleh dipercayai untuk signage dan printing.</h2>
            <p class="section-copy">A&T Media Sdn. Bhd. menumpukan servis yang boleh diharap daripada konsultasi, reka bentuk, produksi, pemasangan, dan penilaian, membantu pelanggan menyiapkan projek signage dengan koordinasi yang jelas.</p>
            <ul class="check-list">
              <li><i class="fas fa-check-circle"></i><span>Sokongan dalaman untuk produksi, reka bentuk, marketing, pemasangan di lokasi, dan penilaian.</span></li>
              <li><i class="fas fa-check-circle"></i><span>Produk merangkumi signboard, signage, printing, fabric lightbox, standee signage, dan 3D lettering.</span></li>
              <li><i class="fas fa-check-circle"></i><span>Liputan servis untuk Kuala Lumpur (KL), Klang Valley, Selangor, dan Seremban.</span></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <section id="reviews" class="reviews-band">
      <div class="container">
        <div class="row mb-4">
          <div class="col-lg-7">
            <div class="section-kicker">Ulasan Google</div>
            <h2 class="section-title">Dipercayai pelanggan di Klang Valley, Selangor, dan Seremban.</h2>
          </div>
          <div class="col-lg-5">
            <p class="section-copy">Maklum balas pelanggan menonjolkan respons pantas, sokongan reka bentuk, mutu kerja, dan kualiti signboard siap pasang.</p>
          </div>
        </div>
        <div class="reviews-summary">
          <div class="reviews-score">
            ...
            <div class="reviews-meta">
              <span class="review-stars" aria-label="5 daripada 5 bintang">★★★★★</span>
            </div>
          </div>
          <div class="google-badge">
            <img src="https://cdn1.npcdn.net/img/1692259633google_logo.png" alt="Google logo">
            <span>Ulasan Google Disahkan</span>
          </div>
        </div>
        <div id="googleReviewsCarousel" class="carousel slide review-carousel" data-ride="carousel" data-interval="7000">
          <ol class="carousel-indicators review-indicators">
            <?php foreach ($reviewSlides as $index => $_slide): ?>
              <li data-target="#googleReviewsCarousel" data-slide-to="<?php echo $index; ?>" class="<?php echo $index === 0 ? 'active' : ''; ?>" aria-label="Papar set ulasan <?php echo $index + 1; ?>"></li>
            <?php endforeach; ?>
          </ol>
          ...
          <a class="carousel-control-prev review-control" href="#googleReviewsCarousel" role="button" data-slide="prev" aria-label="Ulasan sebelumnya">
            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
            <span class="sr-only">Sebelumnya</span>
          </a>
          <a class="carousel-control-next review-control" href="#googleReviewsCarousel" role="button" data-slide="next" aria-label="Ulasan seterusnya">
      ...
      <div class="container">
        <div class="row mb-4">
          <div class="col-lg-7">
            ...
            <h2 class="section-title">Laluan praktikal daripada konsultasi hingga signage siap.</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 mb-4 mb-md-0">
            <div class="process-step">
              ...
              <h3>Konsultasi & Perancangan</h3>
              <p>Kongsi keperluan bisnes, lokasi, jenis sign, artwork, ukuran, atau arah rujukan anda.</p>
            </div>
          </div>
          <div class="col-md-4 mb-4 mb-md-0">
            <div class="process-step">
              <div class="step-number">02</div>
              <h3>Reka Bentuk & Produksi</h3>
              <p>Sahkan reka bentuk, bahan, kaedah produksi, dan timeline sebelum fabrikasi bermula.</p>
            </div>
          </div>
          <div class="col-md-4">
            <div class="process-step">
              ...
              <h3>Pasang & Nilai</h3>
              <p>Signage siap dihantar, dipasang di lokasi, dan disemak untuk memastikan kualiti akhir.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-start">
          <div class="col-lg-5 mb-4 mb-lg-0">
            <div class="section-kicker">Dapatkan sebut harga</div>
            <h2 class="section-title mb-3">Hubungi kami untuk signboard, signage, atau sokongan printing.</h2>
            <p class="section-copy">Hantar butiran projek, artwork, ukuran, dan lokasi anda. A&T Media boleh membantu dengan cadangan, produksi, dan perancangan pemasangan.</p>
          ...
          <div class="col-lg-7">
            <form class="contact-form-card" action="contact-submit.php" method="post">
              <h3>Ceritakan tentang projek anda</h3>
              <div class="form-row">
              ...
              <div class="form-group">
                <label for="contactLocation">Lokasi projek</label>
              ...
              <div class="form-group">
                <label for="contactMessage">Butiran projek</label>
                <textarea id="contactMessage" class="form-control" name="Project_Details" placeholder="Kongsi saiz, kuantiti, timeline, status artwork, keperluan pemasangan, atau idea rujukan." required></textarea>
              </div>
              <button class="btn btn-red btn-lg btn-block" type="submit"><i class="fas fa-paper-plane mr-2"></i>Hantar Pertanyaan</button>
            </form>
          </div>
        </div>
      </div>
    ...
    <a class="whatsapp-float" href="https://wa.me/60167013295?text=Hai%20A%26T%20Media%2C%20saya%20ingin%20mendapatkan%20sebut%20harga%20signage." target="_blank" rel="noopener" aria-label="Chat di WhatsApp">
