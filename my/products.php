...
$siteDescription = 'Terokai produk A&T Media termasuk 3D box up lettering, signboard, signage, printing, fabric lightbox, dan standee signage untuk Kuala Lumpur (KL), Klang Valley, Selangor, dan Seremban.';
...
$catalogHeading = $selectedCategory ? $selectedCategory['title'] : 'Produk Pilihan';
  ...
  <body>
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <?php if ($selectedCategoryPath): ?>
              <li class="breadcrumb-item"><a href="products.php">Produk Kami</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-xl-3">
            <aside class="category-panel" aria-label="Navigasi kategori produk">
              <h2>Kategori</h2>
          ...
          <div class="col-lg-8 col-xl-9">
            <div class="catalog-heading">
              ...
              <div class="catalog-total">
                <?php echo $totalProduk; ?> produk<?php echo $totalPages > 1 ? ' · Halaman ' . $currentPage . ' daripada ' . $totalPages : ''; ?>
              </div>
            </div>
            <div class="row">
              <?php if (!$productsPage): ?>
                <div class="col-12">
                  <div class="alert alert-light border">Tiada produk dijumpai dalam kategori ini.</div>
                </div>
              <?php endif; ?>
                  ...
                  <article id="<?php echo htmlspecialchars($product['id'], ENT_QUOTES, 'UTF-8'); ?>" class="product-card">
                    <a class="product-detail-link" href="product.php?id=<?php echo rawurlencode($product['id']); ?>">
                      <div class="product-image">
                        <img src="<?php echo htmlspecialchars('../' . ltrim($product['image'], '/'), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($product['title'], ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <div class="product-card-body pt-0">
                      <a class="btn btn-red btn-sm" href="<?php echo htmlspecialchars($whatsAppUrl, ENT_QUOTES, 'UTF-8'); ?>">
                        <i class="fab fa-whatsapp mr-1" aria-hidden="true"></i> WhatsApp Kami
                      </a>
                    </div>
                  </article>
                </div>
            ...
            <?php if ($totalPages > 1): ?>
              <nav class="catalog-pagination" aria-label="Halaman produk">
                <?php if ($currentPage > 1): ?>
                  <a href="<?php echo htmlspecialchars(productListUrl($selectedCategoryId ?: null, $currentPage - 1), ENT_QUOTES, 'UTF-8'); ?>">Sebelum</a>
                <?php endif; ?>
                ...
                <?php if ($currentPage < $totalPages): ?>
                  <a href="<?php echo htmlspecialchars(productListUrl($selectedCategoryId ?: null, $currentPage + 1), ENT_QUOTES, 'UTF-8'); ?>">Seterusnya</a>
                <?php endif; ?>
              </nav>
            <?php endif; ?>
          </div>
    ...
    <section class="support-band">
      <div class="container">
        <div class="row mb-4">
          <div class="col-lg-7">
            <div class="section-kicker">Sokongan sehenti</div>
            <h2 class="section-title">Lebih daripada bekalan produk.</h2>
          </div>
          <div class="col-lg-5">
            <p class="section-copy">A&T Media turut membantu perancangan, koordinasi reka bentuk, persediaan produksi, aliran pemasangan, dan cadangan praktikal berdasarkan penggunaan lokasi serta sasaran visibiliti.</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="support-card">
              <h3>Konsultasi</h3>
              <p>Bincangkan jenis sign, lokasi pemasangan, saiz, bahan, dan objektif jenama sebelum produksi bermula.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4">
            <div class="support-card">
              <h3>Artwork & Reka Bentuk</h3>
              <p>Kemaskan arah artwork dan susun atur praktikal untuk hasil signage yang jelas dan tahan lama.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            <div class="support-card">
              <h3>Produksi</h3>
              <p>Selaraskan fabrikasi, kemasan cetakan, dan penyediaan bahan untuk kualiti yang konsisten.</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-3">
            <div class="support-card">
              <h3>Pemasangan</h3>
              <p>Lengkapkan pemasangan di lokasi dengan perhatian pada kedudukan, kemasan, dan persembahan akhir.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-7 mb-4 mb-lg-0">
            ...
            <h2 class="section-title mb-3">Perlu bantuan memilih produk yang sesuai?</h2>
            <p class="section-copy mb-0">Hantar artwork, ukuran, lokasi, atau keperluan pemasangan anda supaya A&T Media boleh mencadangkan pilihan produk yang paling sesuai untuk projek anda.</p>
          </div>
          <div class="col-lg-4 offset-lg-1">
            <div class="contact-box">
              ...
              <a class="btn btn-red btn-block" href="contact.php"><i class="fas fa-paper-plane mr-2"></i>Hantar Maklumat Projek</a>
            </div>
          </div>
        </div>
      </div>
